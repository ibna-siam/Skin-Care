...
export const Home: React.FC = () => {
  ...
  return (
    <div className="space-y-16 sm:space-y-24">
      {/* ========================================================================= */}
      {/* 1. HERO SECTION (Replicating exact layout and photography from design) */}
      {/* ========================================================================= */}
      <section className="relative overflow-hidden bg-cream-200 pt-6 pb-12 sm:pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-5 space-y-6 z-10">
              ...
              {/* CTAs: Shop Men & Shop Women (Matching buttons in design) */}
              <div className="flex flex-wrap gap-3.5 pt-2">
                <Link
                  to="/shop?gender=MEN"
                  className="px-7 py-3 bg-brand-800 hover:bg-brand-900 text-white rounded-md font-semibold text-sm transition-all duration-200 shadow-sm hover:shadow active:scale-95"
                >
                  Shop Men
                </Link>
                <Link
            ...
            {/* Right Hero Image (Models + Skincare bottles matching reference aesthetic) */}
            <div className="lg:col-span-7 relative flex items-center justify-center">
              <div className="relative w-full rounded-2xl overflow-hidden shadow-soft-lg border border-cream-300/60 bg-gradient-to-tr from-cream-300 via-cream-100 to-cream-200">
                ...
                <div className="absolute bottom-4 right-4 bg-white/90 backdrop-blur-md px-3.5 py-2 rounded-xl shadow-md border border-gray-100 flex items-center gap-2">
      ...
      {/* ========================================================================= */}
      {/* 2. CATEGORY DISCOVERY (3 Cards: Men Skincare, Women Skincare, Skin Type Guide) */}
      {/* ========================================================================= */}
      ...
      {/* ========================================================================= */}
      {/* 3. BEST SELLERS (Matching 4-card product grid from reference design) */}
      {/* ========================================================================= */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section Heading with flanking horizontal lines matching design */}
      ...
      {/* ========================================================================= */}
      {/* 4. WHY CHOOSE US (4 Circular Green Badges from reference design) */}
      {/* ========================================================================= */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section Heading with flanking horizontal lines matching design */}
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Carousel Pagination dots matching design */}
        ...
        <div className="bg-brand-900 rounded-3xl p-8 sm:p-12 text-white relative overflow-hidden shadow-xl">
          <div className="relative z-10 max-w-2xl mx-auto text-center space-y-4">
            ...
            <h3 className="font-serif text-2xl sm:text-3xl font-bold">
              Get 10% Off Your First Order in Bangladesh
            </h3>
            <p className="text-xs sm:text-sm text-gray-300 leading-relaxed">
              Subscribe for exclusive skincare routine guides, flash sales on CeraVe & The Ordinary, and dermatologist advice.
            </p>
